...
namespace Allocators.SimpleDLLAllocator
{
    public class Allocator : IAllocator
    {
        ...
        //Header = Size & Status|PrevAddress
        ...
        public void Free(uint address)
        {
            ...
            nextHeader.PrevAddress = currHeader.Address;
...
#pragma warning restore CA1051 // Do not declare visible instance fields
        ...
        protected Header SplitAllocBlock(Header currHeader, uint currSize)
        {
            ...
            freeHeader.PrevAddress = currHeader.Address;
            freeHeader.Write(_memory);

            Header nextHeader = Header.Read(_memory, freeHeader.NextAddress);
            nextHeader.PrevAddress = freeHeader.Address;
            nextHeader.Write(_memory);
        ...
        {
            if (currHeader.PrevAddress == Null)
            {
                return currHeader;
            }

            Header prevHeader = Header.Read(_memory, currHeader.PrevAddress);
